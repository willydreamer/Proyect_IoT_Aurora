...
public class ListaSupervisoresActivosAdapter extends RecyclerView.Adapter<ListaSupervisoresActivosAdapter.SupervisorActivoViewHolder> {

    private Context context;

    private ArrayList<Usuario> listaSupervisores;

    public ListaSupervisoresActivosAdapter(Context context, ArrayList<Usuario> supervisores) {
        this.context = context;
        this.listaSupervisores = supervisores;
    }


    public class SupervisorActivoViewHolder extends RecyclerView.ViewHolder {

        Usuario supervisor;
        ImageView fotoSupervisor;

        public SupervisorActivoViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public ListaSupervisoresActivosAdapter.SupervisorActivoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ListaSupervisoresActivosAdapter.SupervisorActivoViewHolder(view);
        //return null;
    }

    @Override
    public void onBindViewHolder(@NonNull ListaSupervisoresActivosAdapter.SupervisorActivoViewHolder holder, int position) {
        ...
        flecha1.setOnClickListener(view -> {
            Intent intent = new Intent(getContext(), MensajeriaChatActivity.class);
